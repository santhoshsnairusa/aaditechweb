      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="mt-12 lg:mt-0 relative rounded-2xl bg-secondary-100 p-8 flex items-center justify-center min-h-[400px]">
              ...
              <div className="relative z-10 glass-panel bg-white/60 backdrop-blur-md p-6 rounded-xl border border-white/80 shadow-xl max-w-sm w-full">
                <h3 className="font-bold text-secondary-900 mb-4 border-b border-secondary-200 pb-2">Core Focus</h3>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={idx} className="flex items-center text-secondary-700 font-medium text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="bg-white rounded-xl shadow-sm border border-secondary-200 overflow-hidden hover:shadow-md transition-shadow">
                <div className="p-1.5 bg-primary-600"></div>
                <div className="p-6">
                  <h3 className="text-xl font-bold text-secondary-900 mb-4">{service.title}</h3>
                  <ul className="space-y-2">
                    {service.items.map((item, itemIdx) => (
                      <li key={itemIdx} className="text-secondary-600 text-sm flex items-start gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="mt-4 text-xl text-secondary-500 max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredProducts.slice(0, 6).map((product) => (
              <Link href={`/products/${product.slug}`} key={product.id} className="group flex flex-col bg-white border border-secondary-200 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300">
                <div className="h-48 bg-secondary-100 relative overflow-hidden flex items-center justify-center object-cover">
                  {/* Placeholder for Product Image */}
                  <div className="absolute inset-0 bg-secondary-200 flex items-center justify-center text-secondary-400 group-hover:scale-105 transition-transform duration-500">
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <h3 className="text-lg font-bold text-secondary-900 mb-2 group-hover:text-primary-600 transition-colors">{product.name}</h3>
                  <p className="text-secondary-600 text-sm mb-4 line-clamp-3 flex-grow">{product.shortDescription}</p>
      ...
      <section className="bg-primary-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 relative z-10 flex flex-col lg:flex-row items-center justify-between">
          ...
          <div>
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 border border-transparent rounded-md shadow-lg text-lg font-medium text-primary-900 bg-white hover:bg-primary-50 transition-colors"
            >
              Contact Us Today
            </Link>
          </div>
